...
|---|---|---|---|---|
| [Lenovo Legion Toolkit](https://github.com/LenovoLegionToolkit-Team/LenovoLegionToolkit) | `6f19ef48095a32afe439474a65e5b95cf8fa1b24` | GPL-3.0 with its repository-specific plugin exception | External protocol and behavior reference | Not compiled or packaged |
...
| [Microsoft.Management.Infrastructure](https://github.com/PowerShell/MMI) | NuGet `3.0.0` | MIT | In-process CIM for allowlisted Lenovo GameZone and fan getters/setters; uses inbox `mi.dll`. Restores `Runtime.Win` and `Runtime.Unix`; Windows artifacts ship only Win | Runtime dependency |
