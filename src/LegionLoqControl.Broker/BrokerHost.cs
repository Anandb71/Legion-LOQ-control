...
internal static class BrokerHost
{
    ...
    private static HardwareWriteKind MapWriteKind(HardwareWriteTarget target) =>
        target switch
        {
            ...
            HardwareWriteTarget.OvernightCharge => HardwareWriteKind.OvernightCharge,
            HardwareWriteTarget.FnLock => HardwareWriteKind.FnLock,
            HardwareWriteTarget.AlwaysOnUsb => HardwareWriteKind.AlwaysOnUsb,
            HardwareWriteTarget.TouchpadLock => HardwareWriteKind.TouchpadLock,
            HardwareWriteTarget.WinKeyLock => HardwareWriteKind.WinKeyLock,
            HardwareWriteTarget.FourZoneLighting => HardwareWriteKind.FourZoneLighting,
            HardwareWriteTarget.FanTable => HardwareWriteKind.FanTable,
            HardwareWriteTarget.SpectrumKeyboard => HardwareWriteKind.SpectrumKeyboard,
